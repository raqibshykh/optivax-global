  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="absolute right-0 mt-[17px] flex max-h-[480px] w-[calc(100vw-2rem)] max-w-[361px] flex-col overflow-y-auto rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark"
      >
            ...
            >
              <span className="relative block w-full h-10 rounded-full z-1 max-w-10">
                <img
                  width={40}
                  height={40}
                  src={`${import.meta.env.BASE_URL}images/user/user-05.jpg`}
                  alt="User"
                  className="w-full overflow-hidden rounded-full"
                />
