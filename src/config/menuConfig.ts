...
export const MENU_CONFIG: MenuConfig = {
  ...
  super_admin: [
    ...
    { key: "activity-live",     label: "Live Activity",    icon: "users", path: "/activity/live" },
    { key: "activity-reports",  label: "Activity Reports", icon: "chart", path: "/activity/reports" },
    ...
    { key: "advance-salary-audit", label: "Advance Audit Log", icon: "shield", path: "/hr/advance-salary/audit" },
    { key: "audit-logs",      label: "Audit Logs",     icon: "shield",       path: "/admin/audit-logs" },
    { key: "security-audit-logs", label: "Security Audit Logs", icon: "shield", path: "/admin/security-audit-logs" },
    ...
    },
    {
      ...
      subItems: [
        ...
        { key: "sa-prod-ownership",    label: "Client Ownership",   path: "/production/client-ownership" },
    ...
    },
    {
      ...
      subItems: [
        ...
        { key: "sa-hr-salary-slips",    label: "Salary Slips",       path: "/hr/salary-slips" },
        { key: "sa-hr-bulk-slips",      label: "Bulk Salary Slips",  path: "/hr/bulk-salary-slips" },
        { key: "sa-hr-leave",           label: "Leave Requests",     path: "/hr/leave" },
        { key: "sa-hr-attendance",      label: "Daily Attendance",   path: "/hr/attendance" },
        { key: "sa-hr-att-monthly",     label: "Monthly Report",     path: "/hr/attendance/monthly" },
        { key: "sa-hr-att-yearly",      label: "Yearly Report",      path: "/hr/attendance/yearly" },
        { key: "sa-hr-att-analytics",   label: "Analytics",          path: "/hr/attendance/analytics" },
        { key: "sa-hr-att-calendar",    label: "Calendar View",      path: "/hr/attendance/calendar" },
        { key: "sa-hr-att-payroll",     label: "Payroll Impact",     path: "/hr/attendance/payroll" },
        { key: "sa-hr-att-corrections", label: "Audit Log",           path: "/hr/attendance/corrections" },
        { key: "sa-hr-att-import",      label: "Import Attendance", path: "/hr/attendance/import" },
    ...
    },
    {
      ...
      subItems: [
        ...
        { key: "sa-it-punches",     label: "Biometric Punches",    path: "/it/punches" },
        { key: "sa-it-mapping",     label: "Biometric Mapping",    path: "/it/biometric-mapping" },
  ...
  management: [
    ...
    { key: "client-ownership", label: "Client Ownership", icon: "users",       path: "/production/client-ownership" },
  ...
  sales_member: [
    ...
    { key: "activity-live",   label: "My Activity",     icon: "users",       path: "/activity/live" },
    { key: "files",           label: "Files",           icon: "folder",      path: "/sales/files" },
    { key: "it-tickets",      label: "IT Tickets",      icon: "task",        path: "/it/tickets" },
    { key: "my-budget",       label: "My Budget",       icon: "dollar",      path: "/my-budget" },
    { key: "salary-slip",     label: "My Salary Slip",  icon: "file",        path: "/salary-slips" },
    { key: "advance-salary",  label: "Advance Salary",  icon: "dollar",      path: "/advance-salary" },
    { key: "notifications",   label: "Notifications",   icon: "bell",        path: "/sales/notifications" },
    { key: "profile",         label: "Profile",         icon: "user-circle", path: "/sales/profile" },
  ...
  production_member: [
    { key: "dashboard",        label: "Dashboard",          icon: "grid",        path: "/production/dashboard" },
    { key: "my-clients",       label: "My Clients",         icon: "users",       path: "/production/my-clients" },
    { key: "content-requests", label: "Marketing Requests", icon: "task",        path: "/production/content-requests" },
    { key: "deliverables",     label: "Deliverables",       icon: "folder",      path: "/production/deliverables" },
    { key: "tasks",            label: "Tasks",              icon: "task",        path: "/production/tasks" },
    { key: "files",            label: "Files",              icon: "folder",      path: "/production/files" },
  ...
  hr_admin: [
    ...
    { key: "leave",         label: "Leave Requests",icon: "task",        path: "/hr/leave" },
    {
      ...
      icon: "users",
      subItems: [
        { key: "att-daily",       label: "Daily Attendance", path: "/hr/attendance" },
        { key: "att-monthly",     label: "Monthly Report",   path: "/hr/attendance/monthly" },
        { key: "att-yearly",      label: "Yearly Report",    path: "/hr/attendance/yearly" },
        { key: "att-analytics",   label: "Analytics",        path: "/hr/attendance/analytics" },
        { key: "att-calendar",    label: "Calendar View",    path: "/hr/attendance/calendar" },
        { key: "att-payroll",     label: "Payroll Impact",   path: "/hr/attendance/payroll" },
        { key: "att-import",     label: "Import Attendance", path: "/hr/attendance/import" },
      ],
    },
    ...
    { key: "budget",          label: "Budget",          icon: "dollar",      path: "/budget" },
    { key: "salary-slips",       label: "Salary Slips",         icon: "file",        path: "/hr/salary-slips" },
    { key: "bulk-salary-slips",  label: "Bulk Salary Slips",    icon: "dollar",      path: "/hr/bulk-salary-slips" },
    { key: "advance-salary",       label: "Advance Salary",    icon: "dollar",  path: "/hr/advance-salary" },
    { key: "advance-salary-audit", label: "Advance Audit Log", icon: "shield", path: "/hr/advance-salary/audit" },
  ...
  hr_member: [
    ...
    { key: "leave",           label: "My Leaves",       icon: "task",        path: "/hr/leave" },
    {
      ...
      icon: "users",
      subItems: [
        { key: "att-daily",     label: "My Attendance",  path: "/hr/attendance" },
        { key: "att-monthly",   label: "Monthly Report", path: "/hr/attendance/monthly" },
        { key: "att-yearly",    label: "Yearly Report",  path: "/hr/attendance/yearly" },
        { key: "att-analytics", label: "Analytics",      path: "/hr/attendance/analytics" },
        { key: "att-calendar",  label: "Calendar View",  path: "/hr/attendance/calendar" },
  ...
  it_admin: [
    ...
    { key: "punches",        label: "Biometric Punches",     icon: "file",        path: "/it/punches" },
    { key: "mapping",        label: "Biometric Mapping",     icon: "user-circle", path: "/it/biometric-mapping" },
