  ...
  seedKey("optivax_clients", [
    {
      ...
      totalProjects: 3, totalBilled: 11200,
    ...
    },
    {
      ...
      totalProjects: 2, totalBilled: 6800,
    ...
    },
    {
      ...
      totalProjects: 2, totalBilled: 18500,
    ...
    },
    {
      ...
      totalProjects: 2, totalBilled: 22000,
    ...
    },
    {
      ...
      totalProjects: 1, totalBilled: 9500,
...
function seedTasks(): void {
  seedKey("mock_tasks", [
    { id: "t1",  title: "Design login screen",       description: "Create new UI for auth flow",    status: "done",        priority: "high",   assignee: "Emma Wilson",    assigneeId: "u12", dueDate: "2026-06-10", budget: 600,   budgetUsed: 580,  category: "general" },
    { id: "t2",  title: "API integration — leads",   description: "Connect leads CRUD to backend",  status: "in-progress", priority: "high",   assignee: "James Carter",   assigneeId: "u8",  dueDate: "2026-06-18", budget: 800,   budgetUsed: 320,  category: "general" },
    { id: "t3",  title: "Write unit tests",          description: "Cover auth context hooks",       status: "todo",        priority: "medium", assignee: "Liam Park",      assigneeId: "u13", dueDate: "2026-06-22", budget: 400,   budgetUsed: 0,    category: "general" },
    { id: "t4",  title: "Update client portal",      description: "Refresh billing UI",             status: "in-progress", priority: "medium", assignee: "Olivia Brown",   assigneeId: "u10", dueDate: "2026-06-20", budget: 500,   budgetUsed: 210,  category: "general" },
    { id: "t5",  title: "Database schema migration", description: "Add employee tables",            status: "todo",        priority: "high",   assignee: "David Chen",     assigneeId: "u9",  dueDate: "2026-06-25", budget: 1000,  budgetUsed: 0,    category: "general" },
    { id: "t6",  title: "Fix sidebar routing",       description: "Remove dead navigation links",   status: "done",        priority: "high",   assignee: "Noah Davis",     assigneeId: "u14", dueDate: "2026-06-15", budget: 300,   budgetUsed: 280,  category: "general" },
    { id: "t7",  title: "Email campaign scheduler",  description: "Implement send scheduling",      status: "blocked",     priority: "medium", assignee: "Ava Johnson",    assigneeId: "u11", dueDate: "2026-06-30", budget: 700,   budgetUsed: 150,  category: "campaign" },
    { id: "t8",  title: "HR payroll report",         description: "Generate monthly payroll PDF",   status: "todo",        priority: "low",    assignee: "Ethan Lee",      assigneeId: "u15", dueDate: "2026-07-01", budget: 200,   budgetUsed: 0,    category: "general" },
    { id: "t9",  title: "Deploy to staging",         description: "Push latest build to staging",   status: "in-progress", priority: "high",   assignee: "James Carter",   assigneeId: "u8",  dueDate: "2026-06-17", budget: 300,   budgetUsed: 120,  category: "general" },
    { id: "t10", title: "Onboard client — Globex",   description: "Initial setup and handover",     status: "todo",        priority: "medium", assignee: "Sarah Mitchell", assigneeId: "u2",  dueDate: "2026-06-28", budget: 400,   budgetUsed: 0,    category: "general" },
    { id: "t11", title: "Q3 content calendar",       description: "Plan all social posts for Q3",   status: "in-progress", priority: "medium", assignee: "Noah Davis",     assigneeId: "u14", dueDate: "2026-07-05", budget: 350,   budgetUsed: 140,  category: "content" },
    { id: "t12", title: "Mobile UI prototype",       description: "Interactive Figma prototype",    status: "in-progress", priority: "high",   assignee: "Edgar Wright",   assigneeId: "u24", dueDate: "2026-07-10", budget: 1200,  budgetUsed: 480,  category: "general" },
  ]);
}
...
function seedPayments(): void {
  seedKey("mock_payments", [
    ...
    { id: "pay-4",  invoiceId: "inv-5",  amount: 1200,  date: "2026-06-10", method: "Bank Transfer",   transactionId: "TXN-1004", created_at: "2026-06-10T11:00:00Z", status: "completed" },
...
function seedInvoices(): void {
  seedKey("mock_invoices", [
    ...
    },
    {
      ...
      issueDate: "2026-06-15", dueDate: "2026-06-30",
