...
function seedConversations(): Conversation[] {
  return [
      ...
      messages: [
        {
          ...
          senderId: "u4", senderName: "Omar Farooq", senderRole: "sales_admin",
          ...
          sentAt: "2026-06-10T09:00:00Z", readBy: ["u4", "client-001"],
        },
        {
          id: "msg-001-2", conversationId: "conv-001",
          senderId: "client-001", senderName: "Alice Johnson", senderRole: "client",
          body: "Hi Omar! We'll need a product catalog with cart functionality, but full checkout can wait for Phase 2. Does that affect the timeline?",
          sentAt: "2026-06-10T11:45:00Z", readBy: ["u4", "client-001"],
        },
        {
          ...
          sentAt: "2026-06-18T14:30:00Z", readBy: ["u4"],
        },
      ],
    },
    {
      ...
      clientEmail: "m.chen@nexusretail.com",
      assignedDept: "Marketing",
      assignedUserId: "u9",
      assignedUserName: "Layla Hassan",
      ...
      messages: [
        {
          ...
          senderId: "u9", senderName: "Layla Hassan", senderRole: "marketing_admin",
          body: "Hi Marcus, I'm reaching out to discuss your Q3 digital marketing campaign. Based on the brief, I'm proposing a mix of Google Ads and LinkedIn targeting your B2B segment. Can we schedule a call this week to finalize the ad spend allocation?",
          sentAt: "2026-06-12T10:00:00Z", readBy: ["u9", "client-002"],
        },
        {
          id: "msg-002-2", conversationId: "conv-002",
          senderId: "client-002", senderName: "Marcus Chen", senderRole: "client",
          body: "Hi Layla, this sounds great. I'm available Thursday at 3 PM or Friday morning. Also, can you include Instagram in the mix? We've been seeing good engagement there.",
          sentAt: "2026-06-13T09:30:00Z", readBy: ["u9", "client-002"],
        },
        {
          ...
          sentAt: "2026-06-14T11:00:00Z", readBy: ["u9", "client-002"],
        },
        {
          ...
          sentAt: "2026-06-20T16:00:00Z", readBy: ["client-002"],
        },
      ],
    },
    {
      ...
      clientEmail: "priya@innovatesolutions.in",
      assignedDept: "Production",
      assignedUserId: "u14",
      assignedUserName: "Yusuf Okafor",
      status: "open",
      ...
      messages: [
        {
          ...
          senderId: "u14", senderName: "Yusuf Okafor", senderRole: "production_admin",
          body: "Hi Priya, I'm writing to flag that Milestone 2 (backend API integration) is running 3 days behind schedule due to an unexpected dependency issue. New delivery date: June 28. I sincerely apologize for the delay.",
          sentAt: "2026-06-15T08:00:00Z", readBy: ["u14", "client-003"],
        },
        {
          id: "msg-003-2", conversationId: "conv-003",
          senderId: "client-003", senderName: "Priya Sharma", senderRole: "client",
          body: "Thank you for the early notice, Yusuf. June 28 is still within our acceptable window. Can you send an updated project timeline showing the impact on subsequent milestones?",
          sentAt: "2026-06-15T10:30:00Z", readBy: ["u14", "client-003"],
        },
        {
          ...
          sentAt: "2026-06-22T09:00:00Z", readBy: ["u14", "client-003"],
        },
      ],
    },
    {
      ...
      messages: [
        {
          ...
          sentAt: "2026-05-20T10:00:00Z", readBy: ["u4", "client-001"],
        },
        {
          id: "msg-004-2", conversationId: "conv-004",
          senderId: "client-001", senderName: "Alice Johnson", senderRole: "client",
          body: "Hi Omar, we're definitely interested in renewing. The Enterprise tier sounds attractive — please send over the detailed pricing.",
          sentAt: "2026-05-22T09:00:00Z", readBy: ["u4", "client-001"],
        },
        {
    ...
    },
    {
      ...
      clientId: "client-004",
      clientName: "Benjamin Wells",
      clientEmail: "bwells@brightgoods.co",
      assignedDept: "Marketing",
      assignedUserId: "u9",
      assignedUserName: "Layla Hassan",
      status: "awaiting_team",
      ...
      messages: [
        {
          ...
          senderId: "u9", senderName: "Layla Hassan", senderRole: "marketing_admin",
          body: "Hi Benjamin, congratulations on the upcoming product launch! I'd like to propose a 30-day social media blitz starting July 1 — teaser content, influencer partnerships, and targeted paid ads. What platforms are most important to your audience?",
          sentAt: "2026-06-19T14:00:00Z", readBy: ["u9", "client-004"],
        },
        {
          id: "msg-005-2", conversationId: "conv-005",
          senderId: "client-004", senderName: "Benjamin Wells", senderRole: "client",
          body: "Hi Layla! Our core audience is on TikTok and Instagram (18-35 demographic). We've also been thinking about a YouTube unboxing campaign. Budget is around $8K for the launch month.",
          sentAt: "2026-06-20T09:30:00Z", readBy: ["u9", "client-004"],
        },
        {
          ...
          sentAt: "2026-06-22T11:00:00Z", readBy: ["client-004"],
        },
      ],
    },
    {
      ...
      messages: [
        {
          ...
          sentAt: "2026-06-05T10:00:00Z", readBy: ["u14", "client-003"],
        },
        {
          id: "msg-006-2", conversationId: "conv-006",
          senderId: "u14", senderName: "Yusuf Okafor", senderRole: "production_admin",
          body: "Hi Priya, absolutely — we'll get that revised. Could you share 2-3 examples of copy that represents the tone you're going for? This will help our copywriter nail it on the first pass.",
          sentAt: "2026-06-06T09:00:00Z", readBy: ["u14", "client-003"],
        },
        {
          ...
          sentAt: "2026-06-07T11:00:00Z", readBy: ["u14", "client-003"],
        },
        {
          ...
          sentAt: "2026-06-12T16:00:00Z", readBy: ["u14", "client-003"],
        },
      ],
    },
    {
      ...
      assignedUserId: "u2",
      assignedUserName: "Rania Al-Sayed",
      status: "open",
      ...
      messages: [
        {
          ...
          senderId: "u2", senderName: "Rania Al-Sayed", senderRole: "management",
          body: "Hi Marcus, given the strong results we've delivered for Nexus Retail over the past year, I'd love to explore a multi-year strategic partnership. This would give you dedicated team capacity, priority access to new services, and significant cost savings. Would you be open to a call this month?",
          sentAt: "2026-06-17T11:00:00Z", readBy: ["u2", "client-002"],
        },
        {
          id: "msg-007-2", conversationId: "conv-007",
          senderId: "client-002", senderName: "Marcus Chen", senderRole: "client",
          body: "Hi Rania, we'd absolutely be interested. The consistency of service from your team has been impressive. Let's plan for the last week of June — I'll have our CFO on the call as well.",
          sentAt: "2026-06-21T13:00:00Z", readBy: ["u2", "client-002"],
        },
      ],
    },
    {
      ...
      messages: [
        {
          ...
          senderId: "u4", senderName: "Omar Farooq", senderRole: "sales_admin",
          body: "Welcome to Optivax, Benjamin! Your account is now active. You have access to project tracking, file sharing, billing, and direct communication with your assigned team. Your production contact is Yusuf Okafor and your marketing contact is Layla Hassan. Feel free to reach out anytime.",
          sentAt: "2026-06-01T09:00:00Z", readBy: ["u4", "client-004"],
        },
        {
          id: "msg-008-2", conversationId: "conv-008",
          senderId: "client-004", senderName: "Benjamin Wells", senderRole: "client",
          body: "Thank you Omar! The portal looks great. I've already explored the projects section. Looking forward to working with the team!",
          sentAt: "2026-06-03T10:00:00Z", readBy: ["u4", "client-004"],
        },
      ],
    },
  ];
